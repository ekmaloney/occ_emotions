...
cross_walk <- read_csv("/Users/emilymaloney/2yp/data/Identity to GSS Crosswalk.csv")
block_info <- read_csv("/Users/emilymaloney/2yp/data/block_info_bayesact.csv")

#fix the string formatting to match 
cross_walk <- cross_walk %>% 
              mutate(term = tolower(Identity),
...
cross_walk <- cross_walk %>% mutate(isco88 = `ISCO-88`)
...
library(readxl)
isco <- read_excel("/Users/emilymaloney/2yp/data/ISCO88.xls")
