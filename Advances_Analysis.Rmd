...
m2 <- glmer(count ~ dist_emotion + blocks_4 + (1 | id) + (1|emotion), data = gss_long_nomiss, family = poisson())

m3 <- glmer(count ~ dist_emotion + blocks_4 + sex + race + age_std + (1 | id)+ (1|emotion), data = gss_long_nomiss, family = poisson())

m3_5 <- glmer(count ~ dist_emotion + blocks_4 + sex + race + age_std + (1 + dist_emotion | id) +
                (1|emotion), data = gss_long_nomiss, family = poisson())
