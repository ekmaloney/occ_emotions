...
tbl_summary(descriptives, 
            label = list(degree ~ "Education Level", sex ~ "Sex", race ~ "Race", age ~ "Age",
...
m2 <- glmer(count ~ dist_emotion + income_std + degree + prestg_std + (1 | id) + (1|emotion), data = gss_long_nomiss, family = poisson())

m3 <- glmer(count ~ dist_emotion + income_std + (1 | id) + (1|emotion), data = gss_long_nomiss, family = poisson())

m4 <- glmer(count ~ dist_emotion + income_std + sex + race + age_std + (1 | id)+ (1|emotion), data = gss_long_nomiss, family = poisson())

m4_5 <- glmer(count ~ dist_emotion + income_std + sex + race + age_std + (1 + dist_emotion| id)+ (1|emotion), data = gss_long_nomiss, family = poisson())

m4 <- glmer(count ~ dist_emotion*income_std + sex + age_std + race + (1 + dist_emotion| id)+ (1|emotion), data = gss_long_nomiss, family = poisson(), control = lmerControl(optimizer = "bobyqa"))

m5 <- glmer(count ~ dist_emotion*sex + dist_emotion*income_std + race + age_std + (1 + dist_emotion | id)+ (1|emotion), data = gss_long_nomiss, family = poisson())
